...
{
  "duration": "1 week",
  "goal": "Balanced nutrition with Egyptian cuisine",
  "daily_plans": [
    {
      "day": "Saturday",
      "meals": {
    ...
    },
    {
      ...
      "meals": {
        ...
        "dinner": {
          "main": {
            "name": "Mixed Vegetable Salad with Tahini",
          ...
          "alternatives": [
            {
              "name": "Grilled Eggplant with Yogurt",
              "portion": "1 serving",
              "calories": 180,
              "macronutrients": {
                "carbs": 20,
  ...
  "notes": [
    ...
    "Traditional Egyptian spices enhance both flavor and nutrition"
  ]
}
"""
        ];
...
"""
        ...
        public Task<StructuredDietPlan> GenerateDietPlanAsync(UserProfile userProfile)
        {
        ...
        public Task<StructuredWorkoutPlan> GenerateWorkoutPlanAsync(UserProfile userProfile)
        {
